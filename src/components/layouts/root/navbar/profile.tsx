    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className={clsx(
            "w-[calc(100%+32px)] -ml-4 mt-4 py-2.5 px-5.5 active:bg-black-200 transition-colors",
            {
              "text-primary-900 button2-semibold":
      ...
      <div className="absolute bottom-[1.875rem] @mobile:bottom-15 left-1/2 -translate-x-1/2 w-full flex flex-col items-center gap-6">
        ...
        <div className="flex gap-8">
          <button
            ...
            onClick={() =>
              window.open("https://www.instagram.com/kickonfc/", "_blank")
            }
          >
            <Instagram
          ...
          <button
            aria-label={"X로 이동"}
            onClick={() => window.open("https://x.com/kickonfc", "_blank")}
          >
